...
def main():
    ...
    for epoch in range(TRAIN_EPOCHS):
        ...
        file_stats = open(TRAIN_LOGDIR+"/stats.txt", "a")
        file_stats.write("giou_val_loss:{:7.2f}, conf_val_loss:{:7.2f}, prob_val_loss:{:7.2f}, total_val_loss:{:7.2f}\n".
        ...
        if TRAIN_SAVE_CHECKPOINT and not TRAIN_SAVE_BEST_ONLY:
            ...
            print("Saving checkpoint at: ", save_directory)
