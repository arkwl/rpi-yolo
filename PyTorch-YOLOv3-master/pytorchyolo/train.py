...
def train(model, data, epochs=300, n_cpu=8, pretrained_weights=None, checkpoint_interval=1, evaluation_interval=1, multiscale_training="store_false", iou_thres=0.5, conf_thres=0.1, nms_thres=0.5, logdir="logs", seed=-1, verbose=False):
